...
namespace TCPDemoClient
{
    internal static class Program
    {
        static void Main()
        {
            ...
            dataStream.Flush(); // Reste durch den Stream schieben
            dataStream.Close(); // Stream beenden
            connection.Close(); // TCPClient beenden  using ist möglich da der TCPClient das IDisposable implementiert hat
            _ = Console.ReadLine();
        }
    }
}
